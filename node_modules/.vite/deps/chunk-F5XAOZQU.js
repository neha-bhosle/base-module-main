...
function createGrid(options = {}) {
  ...
  const Grid2 = React11.forwardRef(function Grid3(inProps, ref) {
    ...
    let result = (0, import_jsx_runtime9.jsx)(GridRoot, _extends({
      ...
      children: React11.Children.map(children2, (child) => {
...
function joinChildren(children2, separator) {
  const childrenArray = React12.Children.toArray(children2).filter(Boolean);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-F5XAOZQU.js.map
